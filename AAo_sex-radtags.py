...
bigmatrix = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_allfam_2.csv', 'rU').read() # open the file in python
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_female.csv', 'w')
z.write(fin_fem)
z.close()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_female1.csv','w')
z.write(ff)
z.close()

z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_female_lst.csv','w')
z.write(lstj)
z.close()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_female_2.csv','w') 
z.write(Lstj)
z.close()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_female_3.csv','w') 
z.write(Lst5j)
z.close()
...
# As super user, I ran:  
# >>> a = open('AAo_female_3.csv','rU').read()  
# >>> import lrt  
# >>> a_lrt = lrt.out(a)  
# >>> z = open('AAo_femaleqtl0.csv', 'w')   #this file has all the LRT, LOD score and p-values for all the markers in association to sex#  
# >>> z.write(a_lrt)  
# >>> z.close()  
...
fqtl0 = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_femaleqtl0.csv', 'rU').read()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_female_qtl1.csv', 'w')
z.write(','.join(fqtlID))
z.close()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_male.csv', 'w')
z.write(fin_mal)
z.close()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_male1.csv','w')
z.write(mm)
z.close()

z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_male_lst.csv','w')
z.write(lstj)
z.close()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_male_2.csv','w') 
z.write(Lstj)
z.close()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_male_3.csv','w') 
z.write(Lst5j)
z.close()
...
mqtl0 = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_maleqtl0.csv', 'rU').read()
...
z = open('/Volumes/group_dv/personal/DValenzano/May2014/sex-linked/AAo_male_qtl1.csv', 'w')
z.write(','.join(mqtlID))
z.close()
