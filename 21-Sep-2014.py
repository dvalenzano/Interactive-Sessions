...
# Now I need to remove the F1 individuals
...
z = open('/Volumes/group_dv/personal/DValenzano/Sep2014/g_days.csv', 'w')
z.write(gz_days)
z.close()

z = open('/Volumes/group_dv/personal/DValenzano/Sep2014/g_daysM.csv', 'w')
z.write(gz_daysM)
z.close()

z = open('/Volumes/group_dv/personal/DValenzano/Sep2014/g_daysF.csv', 'w')
z.write(gz_daysF)
z.close()
