...
lowz = tab14fas.split('\n')[0] + '\n'+','.join(low1).replace('\n,','\n')
z = open('/Volumes/group_dv/personal/DValenzano/Apr2014/plink/fam_7/fem/fam_14f_sqtl_sig', 'w')
z.write(lowz)
z.close()
...
lowz = tab8mas.split('\n')[0] + '\n'+','.join(low1).replace('\n,','\n')
z = open('/Volumes/group_dv/personal/DValenzano/Apr2014/plink/fam_14/mal/fam_8m_sqtl_sig', 'w')
z.write(lowz)
z.close()
...
lowz = tab8fas.split('\n')[0] + '\n'+','.join(low1).replace('\n,','\n')
z = open('/Volumes/group_dv/personal/DValenzano/Apr2014/plink/fam_7/fem/fam_8f_sqtl_sig', 'w')
z.write(lowz)
z.close()
