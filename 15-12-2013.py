...
lstaao = open('/Volumes/group_dv/personal/DValenzano/Dec2013/AAo-list.txt', 'rU').read()
...
############################################################################################################################
############################################################################################################################
##########              THIS CODE BELOW ITERATES THE CODE ABOVE OVER ALL THE FAMILIES FOR CROSS AAo    ####################       
############################################################################################################################
############################################################################################################################


for fam in lstaao.split('\n')[:-1]:
