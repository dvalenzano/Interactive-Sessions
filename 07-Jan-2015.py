# Goal: same as exome_indelsvcf.py, with the transposed matrix at the end
...
z = open('/Volumes/group_dv/group/data/whole_exome_sequencing_2014_yumi/indels/indels_tab02.csv', 'w')
z.write(tab02)
z.close()
