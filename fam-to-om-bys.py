...
famfile = '/Volumes/group_dv/personal/DValenzano/Mar2014/AAo/inf-fam_%s.csv' % inp
...
outf = '/Volumes/group_dv/personal/DValenzano/May2014/AAo/fem/fam_%sf_OneMap.txt' %inp
...
outm = '/Volumes/group_dv/personal/DValenzano/May2014/AAo/mal/fam_%sm_OneMap.txt' %inp
...
mar = float(finf.split('\n')[0].split()[1])

qtlepif = '/Volumes/group_dv/personal/DValenzano/Apr2014/plink/AAo/fem/fam_%sf.epi.qt' %inp                                                                                
qtlepim = '/Volumes/group_dv/personal/DValenzano/Apr2014/plink/AAo/mal/fam_%sm.epi.qt' %inp                                                         
...
new_ominpef = str(len(finf.split('\n')[1].split('\t')[-1].split(',')))+' '+str(len(Set(inplf.split('\n')[:-1])))+'\n'+','.join([ i+'\n' for i in finf.split('\n')[1:] if i.split('\t')[0][1:] in Set(inplf.split('\n')[:-1])]).replace('\n,','\n')
new_ominpem = str(len(finm.split('\n')[1].split('\t')[-1].split(',')))+' '+str(len(Set(inplm.split('\n')[:-1])))+'\n'+','.join([ i+'\n' for i in finm.split('\n')[1:] if i.split('\t')[0][1:] in Set(inplm.split('\n')[:-1])]).replace('\n,','\n')

outf = '/Volumes/group_dv/personal/DValenzano/May2014/AAo/fem/f%s_omf_epi.txt' % inp
outm = '/Volumes/group_dv/personal/DValenzano/May2014/AAo/mal/f%s_omm_epi.txt' % inp
